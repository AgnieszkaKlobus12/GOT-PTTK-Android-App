...
//        mViewModel = ViewModelProviders.of(this)[MountainPassOfficialViewModel::class.java]
        ...
        binding.saveOfficialPoint.setOnClickListener {
            ...
            val mountainRangeList =
                mViewModel.getMountainRange(binding.mountainRange.text.toString())
            ...
            when (changeNr) {
                0 -> {
                    mViewModel.mountainPassOfficial.value!!.FKpunktPoczatkowy = officialPoint.id
                }
                1 -> {
                    mViewModel.mountainPassOfficial.value!!.FKpunktPosredni = officialPoint.id
                }
                else -> {
                    mViewModel.mountainPassOfficial.value!!.FKpunktKoncowy = officialPoint.id
                }
            }
